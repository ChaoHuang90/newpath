 function [ref] = referencetrajectory_arc29three(manoeuvre,vehicle,parameters)
...
%% constants of nature
g = 9.81; % m/ s2
a = mu*g; % max a c ce l e ra t i o n
r = Vx^2/a; % c i r c u l a r motion
% p0 s t a r t i n g p o s i t i o n
% p1 end of f i r s t s t r a i g h t
% p2 f i r s t approach to f i r s t corner
% p3 end of f i r s t tu rn
% p4 midpoint of f i r s t 2 c i r c l e s
% p5 s t a r t of second tu rn
% p6 second approach to boundary
% p7 end of second tu rn
% p8 s t a r t of t h i r d tu rn
% p9 t h i r d approach to boundary
% p10 end of t h i r d tu rn
% p11 midpoint between 3rd and 4 th c i r c l e s
% p12 s t a r t of f o u r t h tu rn
% p13 f o u r t h approach to boundary
% p14 end of f o u r t h tu rn
% (Xa ,Ya) P1 end of s t r a i g h t , s t a r t of f i r s t arc
% (Xb ,Yb) P3 end of f i r s t arc , s t a r t of s t r a i g h t
% (Xc ,Yc ) P5 end of s t r a i g h t , s t a r t of second arc
% (Xd ,Yd) P7 end of second arc , s t a r t of s t r a i g h t
% (Xe ,Ye) P8 end of s t r a i g h t , s t a r t of t h i r d arc
% ( Xf , Yf ) P10 end of t h i r d arc , s t a r t of s t r a i g h t
% (Xg ,Yg) P12 end of s t r a i g h t , s t a r t of f o u r t h arc
% (Xh ,Yh) P14 end of f o u r t h arc , s t a r t of s t r a i g h t
