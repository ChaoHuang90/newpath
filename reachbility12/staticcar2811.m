function s_vehicle=staticcar2811(half_w,ref)
%%
% static vehicle
...
%%
v1c3=[-0.85 (X2+X1)/2+half_w/2];%%%16.5-15.725=0.7750;20.275-0.7750=19.5000
tvc=0:0.1:2*pi;
...
%%
v1c4=[0.85 (X2+X1)/2+half_w/2];%%%16.5-15.725=0.7750;20.275-0.7750=19.5000
tvc=0:0.1:2*pi;
