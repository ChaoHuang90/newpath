...
function [manoeuvre] = define_manoeuvre2911(parameters)
...
manoeuvre.w5=7;
manoeuvre.l0=0;
manoeuvre.l1=10+v_a*time_step;
manoeuvre.l2=8;
manoeuvre.l3=14-(v_a*time_step-v_a/1.5*time_step);
manoeuvre.l4=8;
manoeuvre.l5=20-v_a/2*time_step;
case 'ISO38881'
lane_offset = 3.5;
