...
for i=1:30
parameters.t=i;
manoeuvre = define_manoeuvre2711(parameters);
%%
[ref] = referencetrajectory_arc26(manoeuvre,vehicle,parameters);
circle=plot(ref.X, ref.Y, 'db',ref.Cx1,ref.Cy1, '-k', ref.Cx2,ref.Cy2, '-k',ref.Cx3,ref.Cy3, '-k',ref.Cx4,ref.Cy4, '-k');
hold on
basic=plot(ref.Xe,ref.Ye,'--r','LineWidth',2);
hold on
%%
%plot figures road condition
limit = cones2711(manoeuvre,ref); % calls define manoeuvre
ylb = limit.Y_lhs;
yub = limit.Y_rhs;
[aw,bw]=size(ylb);
...
s_vehicle=staticcar2711(half_w,ref)
...
%% 
%dynamic vehicle
d_vehicle=dynamiccar2711(half_w,ref)
