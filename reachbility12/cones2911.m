function limit = cones2911(manoeuvre,ref)
dx=0.1;
...
x4 = x3 + manoeuvre.l4;
x5 = x4 + manoeuvre.l5;
yl1 = y0-manoeuvre.w1/4;
yr1 = y0+manoeuvre.w1/4*3;
yl2 = yl1+manoeuvre.w2;
yr2 = yr1;
yr3 = yr2;
yl3 = yr3-manoeuvre.w3;
yr4 = yr3-manoeuvre.w4;
...
+ (x > x5) .* yl5;
limit.Y_rhs(:,1) ...
= (x <= x1) .* yr1 ... % the orignal is yr1, now I changed to 5.25
+ ((x > x1) & (x <= x2)) .* yr2 ...
+ ((x > x2) & (x <= x3)) .* yr3 ...
+ ((x > x3) & (x <= x4)) .* yr4 ...
+ ((x > x4) & (x <= x5)) .* yr5 ...
