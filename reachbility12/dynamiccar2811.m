function d_vehicle=dynamiccar2811(half_w,ref)
%% dynamic vehicle
...
d_vehicle.yve=yve2;
d_vehicle.xve=xve2;
v2c1=[2.6 (X4+X3)/2-half_w/2];%%%16.5-15.725=0.7750;20.275-0.7750=19.5000
tvc=0:0.1:2*pi;
...
%%
v2c4=[4.4 (X4+X3)/2+half_w/2];%%%16.5-15.725=0.7750;20.275-0.7750=19.5000
tvc=0:0.1:2*pi;
